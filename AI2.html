    ...
    async function sendMessage(utterance) {
        try {
            const response = await fetch('https://api-mebo.dev/api', {
                ...
                body: JSON.stringify({
                    api_key: '87f5e3d8-cd6b-43f1-8166-785e2990d1ef191cab743fc1df', // 適切なAPIキーに置き換えてください
                    agent_id: 'bcdb4620-a7db-4edf-b37a-c0135f2b47db191cab64932f', // 適切なエージェントIDに置き換えてください
                    utterance: utterance,
